            ...
            {open === "opportunities" && (
              <div>
                <div style={{ padding: "0 18px 12px", borderBottom: "0.5px solid #e2e6ed", display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
                  ...
                  <button type="button" onClick={() => setOpen(null)} aria-label="Close" style={{ border: "none", background: "#f5f6f8", borderRadius: "50%", width: 28, height: 28, cursor: "pointer", color: "#64748b", fontSize: 14, flexShrink: 0 }}><i className="ti ti-x" aria-hidden="true" /></button>
                </div>
