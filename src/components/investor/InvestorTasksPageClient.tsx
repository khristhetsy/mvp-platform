...
// ─── SVG icon helpers (professional, no emoji) ────────────────────────────────
function IcoList() {
  return <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round"><line x1="8" y1="6" x2="21" y2="6"/><line x1="8" y1="12" x2="21" y2="12"/><line x1="8" y1="18" x2="21" y2="18"/><line x1="3" y1="6" x2="3.01" y2="6"/><line x1="3" y1="12" x2="3.01" y2="12"/><line x1="3" y1="18" x2="3.01" y2="18"/></svg>;
}
function IcoColumns() {
  return <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="3" width="8" height="18" rx="1"/><rect x="13" y="3" width="8" height="18" rx="1"/></svg>;
}
...
function IcoHandshake() {
  return <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round"><path d="M20.42 4.58a5.4 5.4 0 0 0-7.65 0l-.77.78-.77-.78a5.4 5.4 0 0 0-7.65 7.65l.77.78L12 21.23l7.65-8.22.77-.78a5.4 5.4 0 0 0 0-7.65z"/></svg>;
}
function IcoSearch() {
    ...
    <>
      ...
      {showTaskTypeFilter && (
        <div className="mb-3 flex flex-wrap gap-2">
          ...
          {TASK_TYPES.map((tt) => (
            ...
            >
              <span className="inline-flex items-center gap-1.5">{tt.svgIcon} {tt.label}</span>
            </button>
          ))}
        </div>
      )}
      ...
      <div className="mb-3 flex flex-wrap items-center gap-2">
        ...
        <div className="flex overflow-hidden rounded-lg border border-slate-200">
          {([
            { id: "list",     svgIcon: <IcoList />,     title: "List" },
            { id: "kanban",   svgIcon: <IcoColumns />,  title: "Kanban" },
            { id: "timeline", svgIcon: <IcoCalendar />, title: "Timeline" },
            { id: "grid",     svgIcon: <IcoGrid />,     title: "Grid" },
          ] as { id: ViewMode; svgIcon: React.ReactNode; title: string }[]).map((v, i) => (
            <button key={v.id} type="button" title={v.title} onClick={() => setView(v.id)}
              className={`flex items-center gap-1.5 px-3 py-2 text-xs font-medium transition-colors ${i > 0 ? "border-l border-slate-200" : ""} ${
