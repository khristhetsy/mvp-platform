            ...
            {open === "contacts" && (
              <div style={{ padding: "14px 18px" }}>
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 16 }}>
                  ...
                  <button type="button" onClick={() => setOpen(null)} style={{ border: "none", background: "#f5f6f8", borderRadius: "50%", width: 28, height: 28, cursor: "pointer", color: "#6b7280", fontSize: 14 }}><i className="ti ti-x" aria-hidden="true" /></button>
                </div>
              ...
              <div style={{ padding: "14px 18px" }}>
                ...
                <CmoBox
                  ...
                  actions={[
                    ...
                    "<strong style='color:#fff'>Cap volume growth at 20% per month.</strong> Sudden spikes in send volume (even to opt-in lists) trigger spam filters. Ramp up gradually to protect your sender reputation at icapos.com.",
                  ]}
                />
              </div>
            )}
