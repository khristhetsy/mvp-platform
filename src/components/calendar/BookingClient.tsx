...
export function BookingClient({
  ...
  return (
    <div className={`mx-auto overflow-hidden rounded-2xl border border-slate-200/80 bg-white shadow-[var(--shadow-panel)] ${pending ? "max-w-3xl" : "max-w-2xl"}`}>
                ...
                <>
                  ...
                  {loading ? (
                    ...
                    <div className="flex flex-col gap-1.5">
                      {daySlots.map((s) => (
                        <button key={s.start} type="button" onClick={() => { setPending(s); setError(null); }} className="rounded-lg border border-slate-200 py-1.5 text-xs font-semibold text-[#185FA5] hover:border-[var(--blue)] hover:bg-[#E6F1FB]">
