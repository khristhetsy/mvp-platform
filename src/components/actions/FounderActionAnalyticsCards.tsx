    ...
    return (
      <div className="px-5 pb-6 pt-5">
        ...
        <AdviceBox
          lines={[
            criticalCount > 0
              ? `${criticalCount} critical action${criticalCount === 1 ? "" : "s"} should be your first focus today — these directly impact your Preparation completeness and listing visibility.`
              : analytics.open > 0
              ...
              : "No active actions — a great sign. Use this window to review your Preparation completeness and data room completeness.",
            highCount > 0
        ...
        <div className="mt-4 rounded-lg bg-slate-50 px-4 py-3 ring-1 ring-slate-100">
          ...
          <p className="text-xs leading-relaxed text-slate-600">
            {analytics.overdue === 0
              ...
              : `${analytics.overdue} action${analytics.overdue === 1 ? " is" : "s are"} past due. ${critOverdue > 0 ? `${critOverdue} of these are critical — they may already be affecting your Preparation completeness.` : "None are critical, but left unresolved they can compound into compliance or investor trust issues."}`}
          </p>
        </div>
  ...
  return (
    <div className="px-5 pb-6 pt-5">
      ...
      <div className="mt-4 rounded-lg bg-slate-50 px-4 py-3 ring-1 ring-slate-100">
        ...
        <p className="text-xs leading-relaxed text-slate-600">
          {analytics.completedThisWeek === 0
            ? "No actions completed this week yet. Completing actions updates your Preparation completeness and signals operational momentum to the platform."
            : `You've resolved ${analytics.completedThisWeek} action${analytics.completedThisWeek === 1 ? "" : "s"} this week${completedToday > 0 ? `, including ${completedToday} today` : ""}. Each completed action improves your Preparation completeness and reduces the surface area investors can question in due diligence.`}
        </p>
      </div>
      ...
      <AdviceBox
        lines={[
          analytics.completedThisWeek === 0
            ? "Complete at least 1 action today to start building momentum. Even a small win — like uploading a document — improves your Preparation completeness."
