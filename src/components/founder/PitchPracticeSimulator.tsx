...
const DIFFICULTY_STYLES: Record<Difficulty, { bg: string; text: string; label: string }> = {
  ...
  medium: { bg: "#EEEDFE", text: "#534AB7", label: "Standard" },
          ...
          <div className="space-y-1.5">
            {q.framework.map((f, i) => (
              <div key={i} className="flex items-start gap-2">
                <span className="mt-0.5 flex h-4 w-4 shrink-0 items-center justify-center rounded-full text-[8px] font-bold text-white" style={{ background: "#534AB7" }}>{i + 1}</span>
