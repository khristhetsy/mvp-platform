...
export function StageGuideView({ guide }: { guide: StageGuide }) {
  return (
          ...
          return (
            <li key={step.title} className="flex gap-4">
              ...
              <div className="flex flex-col items-center">
                <span className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-[var(--brand-indigo,#2E78F5)] text-sm font-semibold text-white">
                  {i + 1}
                </span>
