      ...
      <div className="mt-4 rounded-lg bg-slate-50 px-4 py-3 ring-1 ring-slate-100">
        ...
        <p className="text-xs leading-relaxed text-slate-600">
          {snapshots.length === 0
            ...
            : trend !== null && trend > 0
            ? `Your Preparation completeness has improved by ${trend} point${trend === 1 ? "" : "s"} since your last report — positive momentum. ${latestScore >= 80 ? "At 80%+, you're in investor-ready territory." : `Continue addressing gaps to reach the 80%+ threshold investors expect from raise-ready companies.`}`
            : trend !== null && trend < 0
      ...
      <AdviceBox
        lines={[
          snapshots.length === 0
            ...
            ? `At ${latestScore}% complete, focus on the critical items first: incorporate your entity, complete your cap table, and upload a current pitch deck. These three items alone can move your Preparation completeness by 20–30 points.`
            ...
            : `Your Preparation completeness of ${latestScore}% puts you in the investor-ready range. Use this as a credibility signal in conversations — a strong diligence profile reduces perceived risk and often leads to faster term sheet decisions.`,
