    ...
    >
      <div className="flex min-w-0 items-center gap-3">
        ...
        <div className="min-w-0">
          ...
          {entry.isCurrentCompany ? (
            <p className="text-[10px] font-semibold uppercase tracking-wide text-indigo-600">Your company</p>
          ) : null}
        </div>
      </div>
...
export function FounderLeaderboard({ entries }: { entries: LearningLeaderboardEntry[] }) {
  ...
  if (entries.length === 0) {
    return (
      <section className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
        <p className="text-[10px] font-semibold uppercase tracking-wide text-indigo-600">Leaderboard</p>
        <h2 className="mt-1 text-sm font-semibold text-slate-950">Founder learning rankings</h2>
        <p className="mt-2 text-sm text-slate-600">Complete modules to appear on the leaderboard.</p>
      </section>
    );
  }
  ...
  return (
    <section className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
      <p className="text-[10px] font-semibold uppercase tracking-wide text-indigo-600">Leaderboard</p>
      <h2 className="mt-1 text-sm font-semibold text-slate-950">Top founders by learning progress</h2>
