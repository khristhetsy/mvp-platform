...
/** Founder + Stage 2 (qualify) + resolved company. Shared by all business-plan routes. */
export async function gateBusinessPlanApi(): Promise<BusinessPlanGate> {
  ...
  if (!isFeatureEnabled(flags, "founder", "business_plan")) {
