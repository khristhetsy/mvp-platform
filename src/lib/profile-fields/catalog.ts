...
export const FIELD_USAGE: FieldUsage[] = [
  ...
  },
  {
    ...
    cells: { "Founder onboarding": { kind: "picks", note: "step 8" }, "Founder settings": { kind: "picks" }, Other: { kind: "none", note: "investor one-pager; admin editor (typed)" } },
    screens: ["/founder/onboarding step 8", "/founder/settings", "/admin/sales/contacts/[id] (typed)", "/f/[slug] investor one-pager"],
    stored: ["companies.annual_revenue_size"], saved: ROUTES_COMPANY, read: ["Not read by any matcher"],
    optionList: ["revenue_size list on this page"], codeRefs: [ONB, SET],
  },
  {
    name: "ARR", list: "arr_band", summary: "companies.arr · investor preferred ARR range",
    cells: { "Founder onboarding": { kind: "typed", note: "step 8" }, "Founder settings": { kind: "picks" }, "Investor onboarding": { kind: "picks", note: "preferred ARR range" }, Matching: { kind: "scores", note: "ARR" }, Other: { kind: "none", note: "admin editor (typed)" } },
    screens: ["/founder/onboarding step 8 (typed)", "/founder/settings", "/admin/sales/contacts/[id] (typed)", "/investor/onboarding preferred ARR range"],
    stored: ["companies.arr", "investor_profiles.preferred_arr_range"], saved: [...ROUTES_COMPANY, "POST /api/investor/onboarding"],
    read: ["investor-company-matching.ts · ARR"], optionList: ["arr_band list on this page"], codeRefs: [SET],
  },
  {
    name: "MRR", list: "mrr_band", summary: "companies.mrr · investor preferred MRR range",
    cells: { "Founder onboarding": { kind: "typed", note: "step 8" }, "Founder settings": { kind: "picks" }, "Investor onboarding": { kind: "picks", note: "preferred MRR range" }, Matching: { kind: "scores", note: "MRR" }, Other: { kind: "none", note: "admin editor (typed)" } },
    screens: ["/founder/onboarding step 8 (typed)", "/founder/settings", "/admin/sales/contacts/[id] (typed)", "/investor/onboarding preferred MRR range"],
    stored: ["companies.mrr", "investor_profiles.preferred_mrr_range"], saved: [...ROUTES_COMPANY, "POST /api/investor/onboarding"],
    read: ["investor-company-matching.ts · MRR"], optionList: ["mrr_band list on this page"], codeRefs: [SET],
  },
  {
...
export const LIST_CONSTANTS: Record<string, string> = {
  ...
  're:(vocab\\.|list: ")revenue_size\\b': "Annual revenue size",
  're:(vocab\\.|list: ")revenue_stage\\b': "Revenue stage",
  're:(vocab\\.|list: ")arr_band\\b': "ARR",
  're:(vocab\\.|list: ")mrr_band\\b': "MRR",
  're:(vocab\\.|list: "|\\(\\)\\.)money_band\\b': "Amount of capital",
