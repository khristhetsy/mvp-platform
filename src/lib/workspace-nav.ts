    ...
    items: [
      ...
      { href: "/admin/social", label: "Social Media Hub", requiredPermission: "view_admin_dashboard" },
      {
        ...
        children: [
          ...
          { href: "/admin/events/email",        label: "Event Template" },
          { href: "/admin/events/registration-fields", label: "Registration fields" },
          { href: "/admin/events/brochure",     label: "Event Brochure" },
...
export const founderWorkspaceNavSectionsV2: WorkspaceNavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/founder/tasks", label: "Tasks", minStage: "qualify" },
      { href: "/founder/help", label: "How it works" },
      { href: "/founder/support", label: "Support" },
    ],
  },
];
