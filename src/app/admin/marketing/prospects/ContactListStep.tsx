  ...
  return (
    <div>
      <div style={{ display: "flex", gap: 8, marginBottom: 12, flexWrap: "wrap", alignItems: "center" }}>
        ...
        <select value={filters.side} onChange={(e) => nav({ side: e.target.value })} style={sel}><option value="">All sides</option><option value="founder">Founders</option><option value="investor">Investors</option><option value="advisor">Advisors</option></select>
