      ...
      {step === 1 && (
        <div>
          {isFounder ? (
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 8 }}>
              <div><label style={{ ...label, color: "#1A6CE4" }}>Side</label><select value={pf.side} onChange={(e) => setPipe({ side: e.target.value })} style={{ ...sel, borderColor: pf.side ? "#2E78F5" : "var(--border)" }}><option value="">Any</option><option value="founder">Founders</option><option value="investor">Investors</option><option value="advisor">Advisors</option></select></div>
