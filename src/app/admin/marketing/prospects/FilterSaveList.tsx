  ...
  return (
    <div style={{ background: "#fff", border: "0.5px solid #e2e6ed", borderRadius: 12, padding: 16, marginBottom: 12, boxShadow: "0 1px 3px rgb(12 35 64 / 0.06)" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 8, marginBottom: 8 }}>
        <div><label style={label}>Side</label><select value={f.side} onChange={(e) => setF({ ...f, side: e.target.value })} style={sel}><option value="">Any</option><option value="founder">Founders</option><option value="investor">Investors</option><option value="advisor">Advisors</option></select></div>
