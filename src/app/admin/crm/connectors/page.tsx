      ...
      <div className="mx-auto max-w-4xl px-4 py-6">
        <div className="mb-5">
          ...
          <p className="mt-1 max-w-2xl text-sm text-slate-600">
            External systems remain the system of record. Their contacts mirror into Contacts for fast views. Run a one-time full import, then an incremental sync keeps the mirror fresh.
          </p>
        </div>
        <ContactSyncTabs
          connectorsSlot={
