          ...
          {filtered.map((r) => (
            <div key={r.id} style={{ border: "0.5px solid #eef1f5", borderRadius: 12, background: "#fff", padding: "13px 15px", marginBottom: 10 }}>
              <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                <span style={{ width: 34, height: 34, borderRadius: "50%", background: "#EEEDFE", color: "#0A1A40", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 12, fontWeight: 500, flexShrink: 0 }}>
