...
export async function PATCH(
  ...
  try {
    ...
    const db = await marketingDb();
    const allowed = ["name", "status", "scheduled_at", "from_name", "from_email", "reply_to", "list_id", "template_id", "subject_override", "body_override", "archived", "group_type", "department"];
